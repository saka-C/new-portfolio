    ...
    return (
      <nav className="flex items-center justify-between py-11 sm:px-16 px-5 bg-primary-500">
        ...
        <div className="flex items-center md:gap-24 gap-4">
          <a href="#about" className="regular sm:text-[24px] text-base">
            About
          </a>
          <a href="#project" className="regular sm:text-[24px] text-base">
            Project
          </a>
          <a href="#experience" className="regular sm:text-[24px] text-base">
            Experience
          </a>
        </div>
      </nav>
